package com.bosonit.bs8.content.infraestructure.controller;
...
import com.bosonit.bs8.content.application.port.GetPersonaPort;
...
public class PersonaController {
    ...
    @GetMapping("/{id}")
    public PersonaOutputDto getPersonaId(@PathVariable("id") int id) {
    ...
    @PutMapping("/{id}")
    public PersonaOutputDto updatePersona(@PathVariable("id") int id, @Valid @RequestBody PersonaInputDto personaInputDto) {
